...
int m40llm_residual_add_rms_norm_f32_weighted_async(M40llmCudaContext* ctx, const void* d_a_f32, const void* d_b_f32, void* d_residual_out_f32, const void* d_weight, void* d_norm_out_f32, uint32_t rows, uint32_t dim, float eps, uint32_t weight_dtype) {
    (void)ctx; (void)d_a_f32; (void)d_b_f32; (void)d_residual_out_f32; (void)d_weight; (void)d_norm_out_f32; (void)rows; (void)dim; (void)eps; (void)weight_dtype; return -1;
}
