...
int m40llm_mlp_gate_up_swiglu_f32xq4_0_gguf_decode_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_W_gate_q4_0, const void* d_W_up_q4_0, void* d_C_f32, int H, int K) {
    (void)ctx; (void)d_A_f32; (void)d_W_gate_q4_0; (void)d_W_up_q4_0; (void)d_C_f32; (void)H; (void)K; return -1;
}
int m40llm_qkv_f32xq4_0_gguf_decode_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_Wq_q4_0, const void* d_Wk_q4_0, const void* d_Wv_q4_0, const void* d_bq_f32, const void* d_bk_f32, const void* d_bv_f32, void* d_Q_f32, void* d_K_f32, void* d_V_f32, int Nq, int Nk, int Nv, int Kdim) {
    (void)ctx; (void)d_A_f32; (void)d_Wq_q4_0; (void)d_Wk_q4_0; (void)d_Wv_q4_0; (void)d_bq_f32; (void)d_bk_f32; (void)d_bv_f32; (void)d_Q_f32; (void)d_K_f32; (void)d_V_f32; (void)Nq; (void)Nk; (void)Nv; (void)Kdim; return -1;
}
...
int m40llm_gemm_f32xq8_0_gguf_f32(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q8_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q8_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}

int m40llm_gemm_f32xq8_0_gguf_f32_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q8_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q8_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
...
int m40llm_gemm_f32xq8_0_gguf_f32_blockloop_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q8_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q8_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}

int m40llm_gemm_f32xq8_0_gguf_f32_shared_activation_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q8_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q8_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
...
int m40llm_gemm_f32xq4_0_gguf_f32(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q4_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q4_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
int m40llm_gemm_f32xq4_0_gguf_f32_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q4_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q4_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
int m40llm_gemm_f32xq4_0_gguf_f32_blockloop_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q4_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q4_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
int m40llm_gemm_f32xq4_0_gguf_f32_decode_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q4_0, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q4_0; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
int m40llm_gemm_f32xq6_k_gguf_f32_decode_async(M40llmCudaContext* ctx, const void* d_A_f32, const void* d_B_q6_k, void* d_C_f32, int M, int N, int K) {
    (void)ctx; (void)d_A_f32; (void)d_B_q6_k; (void)d_C_f32; (void)M; (void)N; (void)K; return -1;
}
...
int m40llm_rms_norm_f32_async(M40llmCudaContext* ctx, const void* d_in, void* d_out, uint32_t rows, uint32_t dim, float eps) {
    (void)ctx; (void)d_in; (void)d_out; (void)rows; (void)dim; (void)eps; return -1;
}
...
int m40llm_rms_norm_f32_weighted_async(M40llmCudaContext* ctx, const void* d_in, const void* d_weight, void* d_out, uint32_t rows, uint32_t dim, float eps, uint32_t weight_dtype) {
    (void)ctx; (void)d_in; (void)d_weight; (void)d_out; (void)rows; (void)dim; (void)eps; (void)weight_dtype; return -1;
}
...
int m40llm_residual_add_f32_async(M40llmCudaContext* ctx, const void* d_a, const void* d_b, void* d_out, size_t n) {
    (void)ctx; (void)d_a; (void)d_b; (void)d_out; (void)n; return -1;
}
int m40llm_swiglu_f32(M40llmCudaContext* ctx, const void* d_gate, const void* d_up, void* d_out, size_t n) {
    (void)ctx; (void)d_gate; (void)d_up; (void)d_out; (void)n; return -1;
}
int m40llm_swiglu_f32_async(M40llmCudaContext* ctx, const void* d_gate, const void* d_up, void* d_out, size_t n) {
    (void)ctx; (void)d_gate; (void)d_up; (void)d_out; (void)n; return -1;
}
...
M40llmKVCache* m40llm_kvcache_create_compressed(M40llmCudaContext* ctx, uint32_t max_seq_len, uint32_t max_batch_size, uint32_t num_heads, uint32_t head_dim, uint32_t recent_window, uint32_t block_size, uint32_t top_blocks, uint32_t representatives, uint32_t representative_policy, uint32_t q8_old_backing) {
    (void)ctx; (void)max_seq_len; (void)max_batch_size; (void)num_heads; (void)head_dim; (void)recent_window; (void)block_size; (void)top_blocks; (void)representatives; (void)representative_policy; (void)q8_old_backing; return (M40llmKVCache*)0x1;
}
...
int m40llm_kvcache_append_token_f32_async(M40llmCudaContext* ctx, M40llmKVCache* kv, uint32_t seq_id, const void* k_dev_f32, const void* v_dev_f32) {
    (void)ctx; (void)kv; (void)seq_id; (void)k_dev_f32; (void)v_dev_f32; return -1;
}
int m40llm_kvcache_append_token_f32_rope_k(M40llmCudaContext* ctx, M40llmKVCache* kv, uint32_t seq_id, const void* k_dev_f32, const void* v_dev_f32, uint32_t past_len, float freq_base, float freq_scale) {
